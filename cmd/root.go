...
var rootCmd = &cobra.Command{
	Use:   "bughunnter2-go",
	Short: "This tool is Modified version of Bugscanner-go join telegram @AdwanceSNI for new updates.",
}
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.bughunnter2-go.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".bughunnter2-go")
	}
